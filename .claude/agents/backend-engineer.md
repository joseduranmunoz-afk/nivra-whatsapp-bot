...
**Anti-patrón a evitar:** asumir que `gerencias = count(nivel0)` cuando schema dice `nivel0=raíz`. Causó bug counts hardcoded.
...
**Si el agente principal te pide saltar algún check por velocidad, rechaza y escala.** La excepción es bug-fix de viernes a la tarde con producto en demo.
